      ...
      <section className="relative overflow-hidden bg-white pt-16 pb-32">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              Bergabunglah bersama {settings?.namaSekolah || 'SMP PGRI 1 Sempor'}. Kami berkomitmen memberikan pendidikan dasar terbaik dengan fasilitas modern dan tenaga pendidik profesional.
            </motion.p>
          ...
          >
            {[
              ...
              },
              {
                ...
                desc: "Ruang kelas nyaman, perpustakaan luas, lab komputer, dan fasilitas olahraga yang memadai."
              }
            ].map((feature, idx) => (
              <motion.div
                key={idx}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto text-lg">
              Ikuti langkah-langkah mudah berikut untuk mendaftarkan putra/putri Anda di SMP PGRI 1 Sempor.
            </p>
          </div>
