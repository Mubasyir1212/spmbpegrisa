...
const GAS_WEB_APP_URL = "https://script.google.com/macros/s/AKfycbzu5JzacJBP3BKeuJFSjsN2BagGbec-qgrNn3p4Ey0mUzP-Y8loNazg_4zMaGSCANKB1w/exec"; 
...
const getInitialMockSettings = (): AppSettings => {
  const defaultSettings: AppSettings = {
    ...
    sambutanKepalaSekolah: "Selamat datang di website resmi SPMB SMP PGRI 1 Sempor. Kami berkomitmen untuk memberikan pelayanan pendidikan terbaik bagi putra-putri Anda. Mari bergabung bersama kami untuk mencetak generasi penerus bangsa yang cerdas, berakhlak mulia, dan berprestasi.",
    ...
    formFields: [
      ...
      { id: "Pilih Kelas", label: "Pilih Kelas", type: "select", options: ["VIP", "Reguler"], required: true },
